...
export default function Home() {
  return (
    <div className="overflow-x-hidden  antialiased  relative  h-screen max-w-screen flex flex-col justify-center items-center"> 
    ...
    <div className='absolute top-0 z-10 flex items-center'>
      ...
      <div className="h-full w-full bg-black bg-grid-white/[0.09] relative flex items-center justify-center overflow-x-hidden">  
        ...
        <div className="p-4 mx-auto relative z-1 w-full pt-10 md:pt-20 px-2">  
          ...
          <span className="text-3xl">Welcome to</span><br/> <span className="text-6xl font-bold">Infinity Edits</span> <br/><span className="text-3xl">where your vision meets our creativity.</span>
          </div>
