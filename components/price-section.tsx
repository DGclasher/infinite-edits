  ...
  return (
    <div className="w-full z-10 font-normal my-16 h-auto items-center text-center justify-center rounded-lg p-8 overflow-x-hidden">
      ...
      <div className="flex flex-wrap gap-8 justify-center items-center mx-auto">
        ...
        <div className="bg-gradient-to-b h-[650px] py-8 from-neutral-800 to-black backdrop-blur-md border border-neutral-600 rounded-xl w-[350px] shadow-md p-6">
          <h2 className="text-2xl  text-white font-semibold mb-1">Video Edit</h2>
          <p className="text-neutral-300 mb-8">This package includes comprehensive video editing services.</p>
        ...
        <div className="bg-gradient-to-b h-[650px] py-8 from-neutral-800 to-black backdrop-blur-md border border-neutral-600 rounded-xl w-[350px] shadow-md p-6">
          <h2 className="text-2xl  text-white font-semibold mb-1">Custom</h2>
          <p className="text-neutral-300 mb-8">Get a custom quote for your specific video editing needs.</p>
          <p className="text-4xl font-bold text-gray-200">₹ 5000</p>
          <button className="w-full justify-center text-center  bg-indigo-700 px-6 py-3 rounded-lg text-white flex items-center gap-2 mt-4">Get Started </button>
          <ul className="mt-4 text-start text-gray-300  space-y-4">
