...
export default function AboutUs() {
  return (
    <div className="w-full z-10 font-normal h-auto items-center   rounded-lg   p-8 overflow-x-hidden">
  ...
  <span className="relative text-white inline-block text-5xl">
    ...
    />
      ...
      <div className="py-8 w-full  ">
        ...
        <div className="w-full h-[1px] bg-gradient-to-r from-zinc-500 to-transparent">
      ...
      <video
        className="w-80 h-[400px] object-cover  mt-8"
        autoPlay
        loop
        muted
        playsInline
