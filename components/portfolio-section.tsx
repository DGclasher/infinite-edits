        ...
        <div className="text-white w-[100vw] flex flex-col justify-center px-4 md:px-16 items-center ">
            ...
            <div className='flex flex-col gap-8 justify-center items-center w-[80%] z-10'>
                <div className=''>
                    ...
                    <p className='py-4 text-sm md:text-xl text-neutral-400'>From YouTube videos to corporate documentaries, our team offers comprehensive video editing services tailored to meet your needs.
                    ...
                    <p className='text-lg'>
                    Our process is straightforward yet thorough: consultation, storyboard approval, editing, client feedback, final touches, and delivery.
                    </p>
                    </div>
                    </div>
                </div>
                ...
                <div className='md:text-center'>
                    <h2 className='text-3xl text-white font-bold'>Thumbnail Designs</h2>
                    <p className='py-4 text-sm md:text-xl md:text-center text-neutral-400'>Catch your audience's attention with custom-designed thumbnails that stand out.
