...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border-4 border-[#1b3e9e] p-2 md:p-6 bg-gradient-to-b from-neutral-800 to-black rounded-[30px] shadow-2xl "
    >
